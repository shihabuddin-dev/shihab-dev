...
const skillsData = {
    Web: [
        ...
        { name: 'Express.js', icon: <SiExpress className="text-white" />, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
    ...
    Tools: [
        ...
        { name: 'GitHub', icon: <FaGithub className="text-white" />, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
        ...
        { name: 'Vercel', icon: <SiVercel className="text-white" />, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
    ...
    Others: [
        ...
        { name: 'Notion', icon: <SiNotion className="text-black dark:text-white" />, borderColor: 'border-black dark:border-white', shadowColor: 'hover:shadow-black/30 dark:hover:shadow-white/30' },

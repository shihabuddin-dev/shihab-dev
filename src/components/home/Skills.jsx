...
const skillsData = {
    Web: [
        ...
        { name: 'Express.js', icon: <SiExpress/>, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
    ...
    Tools: [
        ...
        { name: 'GitHub', icon: <FaGithub className="text-base-content" />, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
        ...
        { name: 'Vercel', icon: <SiVercel />, borderColor: 'border-white', shadowColor: 'hover:shadow-white/30' },
    ...
    Others: [
        ...
        { name: 'Notion', icon: <SiNotion />, borderColor: 'border-black dark:border-white', shadowColor: 'hover:shadow-black/30 dark:hover:shadow-white/30' },
